...
const handleSubmit=(caseNo,newStatus)=>{setAssessments(p=>p.map(a=>a.caseNo===caseNo?{...a,status:newStatus}:a));setSuccessMsg(`Case ${caseNo} updated to ${newStatus}.`);setTimeout(()=>setSuccessMsg(''),5000);};
