 ...
 *
 * Consumption:
 *   • Tailwind 3: imported into tailwind.config.js -> theme.extend (see snippet below).
 *   • Tailwind 4: mirror these values in an @theme {} block (see icrcs-theme.css).
 *
 * Keep colour values here in sync with icrcs-theme.css. Class names
 * (bg-icrcs-navy, text-primary, border-border, ...) then mean the same
 * thing across every portal.
 */
